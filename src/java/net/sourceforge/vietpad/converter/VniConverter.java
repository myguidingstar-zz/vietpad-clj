 ...
 *
 * @author     Quan Nguyen
 * @version    1.1, 21 Octorber 05
 */

package net.sourceforge.vietpad.converter;

public class VniConverter extends Converter {   
     ...
     *
     * @param str     Source string in VNI encoding
    ...
    String replaceFont(String str) {
        return str.replaceAll("VNI[- ](?:Times|Couri|Centur|Brush)", SERIF)
                  .replaceAll("VNI[- ](?:Helve|Aptima)", SANS_SERIF);        
    }
}
